...
todo=(
    ...
    'existsDirectory' '/data/outbox_anonymize' ''
    ...
    'permission' '/data/outbox_anonymize' '777'
    ...
    'owner' '/data/outbox_anonymize' 'processing:processing'
    ...
    'owner' '/data/inbox' 'processing:processing'
